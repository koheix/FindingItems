...
//     // ─── Input System Callbacks (Send Messages モード) ───
//     // PlayerInput の "Invoke Style" が "Send Messages" の場合、
//     // Unity が自動で以下のメソッドを呼び出す。引数なしである必要がある。
...
//     {
//         _sprintPressed = _playerInput.actions["Sprint"].ReadValue<float>() > 0.5f;
//     }
